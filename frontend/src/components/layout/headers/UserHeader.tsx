      ...
      <div className="flex items-center justify-between px-6 py-4">
        <div className="flex items-center">
          <h1 className="text-2xl font-bold text-gray-900">
            {user?.role?.toUpperCase() === 'ADMIN' ? 'Admin Portal - School Management System' :
             user?.role?.toUpperCase() === 'SECRETARY' ? 'Secretary Portal - School Management System' :
             user?.role?.toUpperCase() === 'ACCOUNTANT' ? 'Accountant Portal - School Management System' :
             user?.role?.toUpperCase() === 'CFO' ? 'CFO Portal - School Management System' :
             user?.role?.toUpperCase() === 'HR' ? 'HR Portal - School Management System' :
             user?.role?.toUpperCase() === 'SUPERUSER' ? 'Super User Portal - School Management System' :
             user?.role?.toUpperCase() === 'SUPER_TEACHER' ? 'Super Teacher Portal - School Management System' :
             user?.role?.toUpperCase() === 'SPONSOR' ? 'Sponsor Portal - School Management System' :
             user?.role?.toUpperCase() === 'PARENT' ? 'Parent Portal - School Management System' :
             user?.role?.toUpperCase() === 'NURSE' ? 'Nurse Portal - School Management System' :
             user?.role?.toUpperCase() === 'SPONSORSHIPS_OVERSEER' ? 'Overseer Portal - School Management System' :
             user?.role?.toUpperCase() === 'SPONSORSHIP_COORDINATOR' ? 'Coordinator Portal - School Management System' :
             user?.role?.toUpperCase() === 'TEACHER' ? 'Teacher Portal - School Management System' :
             `${user?.role || 'User'} Portal - School Management System`}
          </h1>
        </div>
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="relative">
            ...
            >
              <div className="p-4 border-b font-semibold text-gray-900">Teacher Notifications & Messages</div>
