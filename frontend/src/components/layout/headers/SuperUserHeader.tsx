...
const SuperUserHeader: React.FC = () => {
  ...
  // Detect locked accounts (for superuser only)
  ...
  // Add locked accounts notifications for superuser
      ...
      <div className="flex items-center justify-between px-6 py-4">
        <div className="flex items-center">
          <h1 className="text-2xl font-bold text-gray-900">
            Super User Portal - School Management System
          </h1>
        </div>
        ...
        <div className="flex items-center space-x-4">
          <div className="relative">
            ...
            >
              <div className="p-4 border-b font-semibold text-gray-900">Super User Notifications & Messages</div>
              <ul className="max-h-80 overflow-y-auto">
                {/* Locked Accounts Section */}
                {lockedAccountsCount > 0 && (
                  <>
                    <li className="px-4 py-2 text-xs text-red-700 font-bold bg-red-50">Locked Accounts ({lockedAccountsCount})</li>
                    {lockedAccountNotifications.map((n) => (
                      <li
                        key={n.id}
                        className="px-4 py-3 border-b last:border-b-0 bg-red-50 transition-colors duration-200 group cursor-pointer hover:bg-red-100"
                      >
