...
const app = express();
const PORT = 5173; // Using port 5173 since it's already working
...
app.get('/api/health', (req, res) => {
  ...
  res.json({
    status: 'healthy',
    message: 'Port 5173 sponsorship server is running',
...
app.listen(PORT, '127.0.0.1', () => {
  console.log(`🚀 Port 5173 sponsorship server running on http://127.0.0.1:${PORT}`);
